  ...
  return (
    ...
    <div className="flex flex-col md:flex-row items-center">
      <div className="w-full md:w-1/2 flex justify-center">
        <img src="Icon8.png" className="w-72 px-5" alt="Icon8" />
      </div>
      <div className="w-full md:w-1/2 ml-0 md:ml-10 mt-6 md:mt-0 px-5">
        <div className="w-5/6 md:w-3/4">
          <p className="break-words font-bold text-base md:text-3xl text-left ">Krado Came Up With The Latest Technology</p>
        </div>
        <div className="mt-6">
