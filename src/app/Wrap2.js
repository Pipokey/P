  ...
  <div className="flex flex-col md:flex-row items-center">
    ...
    <div className="w-full md:w-1/2 ml-0 md:ml-10 mt-6 md:mt-0 px-5">
      <div className="w-5/6 md:w-4/5">
        <p className="break-words font-bold text-base md:text-3xl text-left">Krado Modern Design With Wireless Gadget</p>
      </div>
      <div className="mt-6">
    ...
    <div className="w-full md:w-1/2 md:ml-44 flex justify-center order-first md:order-last">
